...
const EnvelopeAnimation = ({ isVisible, animationsEnabled, score = 0 }: EnvelopeAnimationProps) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-full px-4" data-testid="envelope-animation">
      {/* Envelope */}
      <motion.div
      ...
      <AnimatePresence>
        {showPaper && (
          <motion.div
            className="absolute z-20 left-0 right-0 mx-auto flex justify-center"
          ...
          >
            {/* Paper background */}
            <div className={`rounded-lg shadow-2xl p-4 md:p-6 w-[280px] md:w-[320px] transform ${
              isPremium 
