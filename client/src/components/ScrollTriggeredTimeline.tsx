...
const TimelineCard: React.FC<TimelineCardProps> = ({ timelineEvent, i }) => {
    ...
    const getEventDescription = (eventName: string): string => {
        const descriptions: Record<string, string> = {
            "Arrival at the Church": "Join us as we gather to celebrate our special day. Please arrive on time.",
            "Wedding Ceremony": "Witness our vows and the beginning of our journey together as we exchange rings and promises.",
            "Cocktail Hour & Photobooth": "Enjoy light refreshments and capture beautiful moments with our loved ones at the photobooth.",
            "Program & Dinner": "A delicious meal followed by touching speeches from our closest family and friends.",
            "We Party!": "Let's celebrate with music and dancing as we create unforgettable memories together."
        };
...
const timelineEvents: TimelineEvent[] = [
    ...
    {
        time: "6:00 PM",
        event: "Cocktail Hour & Photobooth", 
        icon: Camera,
        hueA: 40, // Gold
        hueB: 40, // Gold
    },
